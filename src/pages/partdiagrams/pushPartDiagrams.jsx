  ...
  <div>
    <div id="partDiagramsContainer" className='subsectionContainer'>
      <div id="explain" className='marginTop3rem regText'>
        <span className="text-4xl text-neutral-200 font-bold my-3">This will push:</span><br />
      ...
      <div>
        <button className="text-neutral-200 bg-gradient-to-r from-cyan-800 to-slate-800 hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-4xl font-semibold px-5 py-3 mt-4 me-2 mb-2 transition hover:scale-105" id='pushButton' onClick={pushToStoresAction}>Push</button>
      </div>
    </div>
  </div>
  );
